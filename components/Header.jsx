                ...
                <div className="big-off header-bar-small">
                    ...
                    <div className="header-flags">
                        ...
                        <div className="header-flags-flex">
                            <img src="/flags/english.jpg" className="flag" onClick={() => {handleFlag("en")}} />
                            <img src="/flags/polish.jpg" className="flag" onClick={() => {handleFlag("pl")}} />
                            <img src="/flags/spanish.jpg" className="flag" onClick={() => {handleFlag("es")}} />
                        </div>
                    </div>
                </div>
